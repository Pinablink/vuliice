...
#define  LEN_KEY_CONTENT          0208H // TAMANHO DO CONTEUDO DA CHAVE - É COMPUTADO SEMPRE QUE FOR ENCONTRADO UM CARACTER VÁLIDO
#define  LEN_VALUE_CONTENT        0209H // TAMANHO DO CONTEUDO DO VALOR
#define  INDICE_CTR_LOOP_LIMITE   020AH // CONTROLA O LOOP DO MECANISMO DE LIMITE PARA VALIDAÇÃO DE UM CARACTER INFORMADO
#define  REG_CARACTER_INVALIDO    020BH //
#define  CARAC_SPACE_             020CH // VALOR 1 - INFORMA QUE O CARACTER BRANCO FOI LIDO
#define  CONF_IN_SERIAL_DATA      020DH
